...
# 2. Data Aquisition
Data from MIMIC-IV can be accessed after completing the required training and signing the data use agreement. Below is a placeholder for loading the data once you have access.
```{r data-acquisition}
